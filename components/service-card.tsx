...
export function ServiceCard({ item, num, labels }: ServiceCardProps): React.ReactElement {
  ...
  return (
    <div className="group relative w-full sm:aspect-square [perspective:1200px]">
      ...
      >
        ...
        <button
          type="button"
          aria-label={`${item.accessibleTitle} — ${labels.flipFront}`}
        ...
        <button
          type="button"
          aria-label={`${item.accessibleTitle} — ${labels.flipBack}`}
