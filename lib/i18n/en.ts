...
export const en: Dictionary = {
  ...
  nav: {
    ...
    statusPill: 'live · operating · 3 slots aug/26',
  ...
  changelog: {
    ...
    entries: [
      { text: 'Fonte · source-cited document RAG, open source.' },
      { text: 'VODGOS · institutional site and council area live.' },
      { text: 'Agenharia · internal panel for the agent-run operation live.' },
  ...
  founder: {
    ...
    bio2: 'Donadão Labs is the operation I run: thirteen products live, four in progress, and current focus on AI agents for businesses already earning, but still operating on WhatsApp.',
  },
  faq: {
    eyebrow: 'FAQ',
